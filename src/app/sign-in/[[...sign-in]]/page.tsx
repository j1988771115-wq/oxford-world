    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="bg-surface-container-lowest p-10 rounded-2xl deep-diffusion w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-on-surface mt-4">登入</h1>
        </div>

        {/* OAuth — disabled until configured */}
        <div className="space-y-3 mb-6">
          <button
            disabled
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-outline-variant/30 text-on-surface-variant font-bold text-sm opacity-50 cursor-not-allowed"
          >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-on-surface-variant text-xs font-bold">使用 Email 登入</span>
          <div className="flex-1 h-px bg-outline-variant/30" />
        </div>
