      ...
      <div className="bg-surface-container-lowest p-10 rounded-2xl deep-diffusion w-full max-w-md">
        ...
        <div className="space-y-3 mb-6">
          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-outline-variant/30 text-on-surface font-bold text-sm hover:bg-surface-container transition"
            >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-on-surface-variant text-xs font-bold">或</span>
          <div className="flex-1 h-px bg-outline-variant/30" />
        </div>

        {success ? (
          <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 p-4 rounded-xl text-center">
